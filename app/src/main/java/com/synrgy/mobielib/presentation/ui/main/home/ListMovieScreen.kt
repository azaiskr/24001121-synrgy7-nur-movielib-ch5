...
import com.synrgy.mobielib.presentation.ui.components.MovieColumn
import com.synrgy.mobielib.presentation.ui.components.MovieRow
...
fun ListMovieScreen(
    ...
    LazyColumn(
        ...
        item {
            Column {
                ...
                when (movieNowPlaying) {
                    ...
                    is Resource.Success -> {
                        val nowPlayingMovies =
                            (movieNowPlaying as Resource.Success<MovieListResponse>).data
                        HorizontalMovieList(
                ...
                when (movieTopRated) {
                    ...
                    is Resource.Success -> {
                        val topRatedMovies =
                            (movieTopRated as Resource.Success<MovieListResponse>).data
                        HorizontalMovieList(
        ...
        when (moviePopular) {
            ...
            is Resource.Success -> {
                val mvPopular = (moviePopular as Resource.Success<MovieListResponse>).data
